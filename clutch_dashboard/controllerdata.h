...
class ControllerData : public QObject
{
    Q_OBJECT
public:
    explicit ControllerData(QWidget *parent = nullptr);

    QSettings settings;
    bool LoadDisplayMessage(QString src);
    unsigned char controller_id = 0;
    qint16 connection_timer = 5;
